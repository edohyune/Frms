...
{
    public class HR350_G10 : EpicV004.Libs.MdlBase
    {
        private long _pid;
        public long pid
        {
        ...
        private DateTime _health_check_date;
        public DateTime health_check_date
        {
            get => _health_check_date;
            set => Set(ref _health_check_date, value);
        }
