namespace EpicV004.Frms
{
    partial class HR532
    {
		...
		private void InitializeComponent()
		{
			...
			ucPanel1.Controls.Add(dapt_name);
			...
			// dapt_name
			// 
			dapt_name.Appearance.Font = new Font("Tahoma", 9F);
			dapt_name.Appearance.Options.UseFont = true;
			dapt_name.ControlHeight = 21;
			dapt_name.ControlWidth = 183;
			dapt_name.FontColor = Color.Black;
			dapt_name.FontFace = "Tahoma";
			dapt_name.FontSize = 9F;
			dapt_name.FormatStr = "";
			dapt_name.Location = new Point(451, 28);
			dapt_name.Name = "dapt_name";
			dapt_name.Size = new Size(183, 21);
			dapt_name.TabIndex = 0;
			dapt_name.TextAlignment = DevExpress.Utils.HorzAlignment.Near;
			dapt_name.Title = "";
			dapt_name.TitleAlignment = DevExpress.Utils.HorzAlignment.Near;
			dapt_name.TitleWidth = 1;
			// 
			// dept
			// 
			...
			dept.ControlWidth = 196;
			dept.FontColor = Color.Black;
			dept.FontFace = "Tahoma";
			dept.FontSize = 9F;
			dept.FormatStr = "";
			dept.Location = new Point(249, 28);
			dept.Name = "dept";
			dept.Size = new Size(196, 21);
			dept.TabIndex = 0;
        ...
        private Ctrls.UCTextBox dapt_name;
