namespace EpicV004.Frms
{
    partial class HR430
    {
		...
		private void InitializeComponent()
		{
			...
			ucPanel1.TabIndex = 0;
			ucPanel1.Text = "Annual Leave Status";
			// 
			// date
			// 
			...
			position.Location = new Point(506, 26);
			position.Margin = new Padding(4, 3, 4, 3);
			position.Name = "position";
			position.Size = new Size(247, 21);
			position.TabIndex = 2;
			...
			job_site.Location = new Point(759, 26);
			...
			s_emp_status.Location = new Point(1013, 24);
			...
			section.FontSize = 9F;
			section.Location = new Point(759, 53);
			...
			project.FontSize = 9F;
			project.FormatStr = "";
			project.Location = new Point(505, 51);
			...
			dept_name.ControlHeight = 22;
			dept_name.ControlWidth = 132;
			dept_name.FontColor = Color.Black;
			dept_name.FontFace = "Tahoma";
			dept_name.FontSize = 9F;
			dept_name.FormatStr = "";
			dept_name.Location = new Point(367, 51);
			dept_name.Name = "dept_name";
			dept_name.Size = new Size(132, 22);
			...
			dept.ControlHeight = 22;
			dept.ControlWidth = 158;
